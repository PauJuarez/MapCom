            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-xl p-6 bg-info-variant-1-5">
                ...
                <form id="filterForm" method="GET" action="{{ route('botigues.mapa') }}" class="mb-6">
                    <div class="flex flex-col">
                        ...
                        {{-- Input ocult amb IDs seleccionades --}}
                        ...
                        @foreach($botigues as $botiga)
                            <li class="relative py-6 px-4 bg-info-variant-1 hover:bg-blue-100 rounded-xl shadow-md transition-all duration-300 ease-in-out ">
                                ...
                                <div class="flex items-center justify-left">
                                    ...
                                    {{-- Accions a la part superior dreta --}}
                                    <div class="absolute top-2 right-2 flex space-x-2">
                                        ...
                                        {{-- Botó afegir o treure de favorits --}}
                                        @php
                                            $user = auth()->user();
                ...
                {{-- Paginació i selector de per_page --}}
...
{{-- Script per enviar automàticament el formulari de per_page --}}
<script>
...
{{-- Script per gestionar selecció de característiques i redirigir --}}
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        buttons.forEach(button => {
            button.addEventListener('click', function () {
                ...
                selected = selected.filter(Boolean); // Eliminar buits

                const index = selected.indexOf(id);
                if (index === -1) {
                    selected.push(id); // Afegir
                } else {
                    selected.splice(index, 1); // Treure
                }
