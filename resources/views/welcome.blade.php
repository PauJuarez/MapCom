...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body style="background-color:#e3e4fc;" class="bg-[#FDFDFC] text-[#1b1b18] flex items-center min-h-screen flex-col">
        ...
        <div  class="flex flex-col items-center justify-center w-full lg:max-w-4xl max-w-[335px]">
            <h1 style="color: #050c3b"class="text-3xl lg:text-5xl font-bold text-center mb-6 text-[#1b1b18]">
                Us donem la benvinguda a MapCom
            </h1>
            <p style="color: #050c3b" class="text-sm lg:text-base text-center mb-6 text-[#1b1b18]">
            ...
            <div style="color: #050c3b" class="bg-[#FDFDFC] border border-[#19140035] rounded-sm p-4 mb-6">
                <code class="text-sm text-[#1b1b18]">
